...
$newsletter = mod_newsletter\newsletter::get_newsletter_by_course_module($id, true);
...
$params = array(
    ...
    NEWSLETTER_PARAM_FROM => optional_param(NEWSLETTER_PARAM_FROM, NEWSLETTER_FROM_DEFAULT,
            PARAM_INT),
    NEWSLETTER_PARAM_FROMISSUE => optional_param(NEWSLETTER_PARAM_FROMISSUE, NEWSLETTER_FROMISSUE_DEFAULT, PARAM_INT),
